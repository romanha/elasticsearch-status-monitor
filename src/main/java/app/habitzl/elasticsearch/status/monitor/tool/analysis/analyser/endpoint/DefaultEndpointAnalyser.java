...
/**
 * The default strategy of the {@link EndpointAnalyser}.
 */
public class DefaultEndpointAnalyser implements EndpointAnalyser {
    private static final Logger LOG = LogManager.getLogger(DefaultEndpointAnalyser.class);
    ...
    @Inject
    public DefaultEndpointAnalyser(final HostnameResolver hostnameResolver, final StatusMonitorConfiguration configuration) {
