...
public class StatusMonitorConfiguration implements Serializable {
	...
	/**
	 * Gets the IP address of the Elasticsearch endpoint.
	 */
	public String getIpAddress() {
		return Objects.nonNull(ipAddress) ? ipAddress : DEFAULT_IP_ADDRESS;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(usingHttps, ipAddress, port);
	}
