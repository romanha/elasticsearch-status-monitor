...
/**
 * Integration tests for a not reachable Elasticsearch 6 installation.
 */
@Disabled("Only intended for manual runs against a local Elasticsearch cluster")
public class UnreachableClusterElasticsearch6IntegrationTest extends AbstractElasticsearchIntegrationTest {
