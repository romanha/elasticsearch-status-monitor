...
class ArchiveReportFileProviderTest {

    private ArchiveReportFileProvider sut;
    private Clock clock;
    ...
    void setUp() {
        ...
        sut = new ArchiveReportFileProvider(clock, fileCreator, configuration);
    }

    @Test
    void get_skippingArchiveReportIsEnabled_doNotCreateReportFile() {
        // Given
    ...
    void get_reportFileNotExistingYet_returnNewReportFile() throws Exception {
        ...
        // Then
        File expectedResult = Paths.get(configuration.getReportFilesPath(), getExpectedFileTimestamp(), ArchiveReportFileProvider.REPORT_FILE_NAME)
                .toFile();
    ...
    private String getExpectedFileTimestamp() {
        return DateTimeFormatter.ofPattern(ArchiveReportFileProvider.TIMESTAMP_FILE_PATTERN)
